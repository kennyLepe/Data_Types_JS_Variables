...
var dato2 = true; 
var dato3 = 0;
console.log(Number(dato1)); console.log(String(dato1)); console.log(Boolean(dato1));
console.log(Number(dato2)); console.log(String(dato2)); console.log(Boolean(dato2));
console.log(Number(dato3)); console.log(String(dato3)); console.log(Boolean(dato3));

var dato4 = 1;
var dato5 = "0"; 
var dato6 = "000";
console.log(Number(dato4)); console.log(String(dato4)); console.log(Boolean(dato4));
console.log(Number(dato5)); console.log(String(dato5)); console.log(Boolean(dato5));
console.log(Number(dato6)); console.log(String(dato6)); console.log(Boolean(dato6));
...
console.log("Bolean()-----------------------"); 
console.log(Boolean(dato13)); console.log("Tipo " + typeof(Boolean(dato13)));

var dato14 = null; 
console.log(dato14); console.log(typeof(dato14));
console.log("Number()-----------------------"); 
...
console.log("Bolean()-----------------------"); 
console.log(Boolean(dato14)); console.log("Tipo " + typeof(Boolean(dato14)));
